...
- This mod has no internet connections at all. If User encounters any Firewall problem by this mod, please dont allow any connections.
  The provider does not know why this happens yet. All origianl codes before changing are from authors cited above and the provider has added no codes about outgoing connections. However　if you see documents on web from clicking on IBL GUI, this shall not be apply to the limitation.
